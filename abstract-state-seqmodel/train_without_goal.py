...
# different from train.py: Checkpoint callback and no test
...
def main(cfg: DictConfig):
    ...
    if cfg.resume:
        trainer.fit(model=mtm, train_dataloaders=dm.train_dataloader(), val_dataloaders=dm.val_dataloader(), ckpt_path=cfg.ckpt_path)
    else:
